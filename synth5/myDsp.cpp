  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec0[0] = 1;
			iRec1[0] = (iVec0[1] + iRec1[1]) % 16384;
			table[i1] = std::sin(0.0003834952f * float(iRec1[0]));
			iVec0[1] = iVec0[0];
			iRec1[1] = iRec1[0];
		}
	}
...
static float ftbl0mydspSIG0[16384];
...
class mydsp : public dsp {
 ...
 public:
	...
	static void classInit(int sample_rate) {
		...
		sig0->fillmydspSIG0(16384, ftbl0mydspSIG0);
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider2 = FAUSTFLOAT(587.33f);
		fCheckbox0 = FAUSTFLOAT(0.0f);
		fHslider3 = FAUSTFLOAT(349.2f);
		fCheckbox1 = FAUSTFLOAT(0.0f);
		fHslider4 = FAUSTFLOAT(523.25f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("filterFreq", &fHslider6, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4e+02f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freq1", &fHslider5, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freq2", &fHslider4, FAUSTFLOAT(523.25f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freq3", &fHslider3, FAUSTFLOAT(349.2f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freq4", &fHslider2, FAUSTFLOAT(587.33f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addCheckButton("gate", &fCheckbox4);
		ui_interface->addCheckButton("gate1", &fCheckbox3);
		ui_interface->addCheckButton("gate2", &fCheckbox2);
		ui_interface->addCheckButton("gate3", &fCheckbox1);
		ui_interface->addCheckButton("gate4", &fCheckbox0);
		ui_interface->addHorizontalSlider("index1", &fHslider1, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("modfreq1", &fHslider0, FAUSTFLOAT(5e+01f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow7 = float(fCheckbox2);
		float fSlow8 = float(fHslider5);
		float fSlow9 = float(fCheckbox3);
		float fSlow10 = float(fCheckbox4);
		float fSlow11 = 1.0f / std::tan(fConst2 * float(fHslider6));
		float fSlow12 = 1.0f - fSlow11;
		float fSlow13 = 1.0f / (fSlow11 + 1.0f);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec3[0] = fSlow0 + (fRec3[1] - std::floor(fSlow0 + fRec3[1]));
			float fTemp0 = fSlow1 * ftbl0mydspSIG0[int(16384.0f * fRec3[0])];
			float fTemp1 = fRec2[1] + fConst1 * (fSlow2 + fTemp0);
			fRec2[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = fRec4[1] + fConst1 * (fSlow4 + fTemp0);
			fRec4[0] = fTemp2 - std::floor(fTemp2);
			float fTemp3 = fRec5[1] + fConst1 * (fSlow6 + fTemp0);
			fRec5[0] = fTemp3 - std::floor(fTemp3);
			float fTemp4 = fRec6[1] + fConst1 * (fSlow8 + fTemp0);
			fRec6[0] = fTemp4 - std::floor(fTemp4);
			float fTemp5 = fSlow10 * (fSlow9 * ftbl0mydspSIG0[int(16384.0f * fRec6[0])] + fSlow7 * ftbl0mydspSIG0[int(16384.0f * fRec5[0])] + fSlow5 * ftbl0mydspSIG0[int(16384.0f * fRec4[0])] + fSlow3 * ftbl0mydspSIG0[int(16384.0f * fRec2[0])]);
			fVec1[0] = fTemp5;
			fRec0[0] = 0.0f - fSlow13 * (fSlow12 * fRec0[1] - (fTemp5 + fVec1[1]));
	...
	FAUST_ADDHORIZONTALSLIDER("filterFreq", fHslider6, 1e+02f, 0.0f, 4e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freq1", fHslider5, 4.4e+02f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freq2", fHslider4, 523.25f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freq3", fHslider3, 349.2f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freq4", fHslider2, 587.33f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDCHECKBOX("gate", fCheckbox4);
	FAUST_ADDCHECKBOX("gate1", fCheckbox3);
	FAUST_ADDCHECKBOX("gate2", fCheckbox2);
	FAUST_ADDCHECKBOX("gate3", fCheckbox1);
	FAUST_ADDCHECKBOX("gate4", fCheckbox0);
	FAUST_ADDHORIZONTALSLIDER("index1", fHslider1, 1.0f, 0.0f, 2e+01f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("modfreq1", fHslider0, 5e+01f, 0.1f, 1e+02f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, filterFreq, "filterFreq", fHslider6, 1e+02f, 0.0f, 4e+02f, 0.1f) \
		p(HORIZONTALSLIDER, freq1, "freq1", fHslider5, 4.4e+02f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freq2, "freq2", fHslider4, 523.25f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freq3, "freq3", fHslider3, 349.2f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freq4, "freq4", fHslider2, 587.33f, 2e+01f, 5e+03f, 0.1f) \
		p(CHECKBOX, gate, "gate", fCheckbox4, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gate1, "gate1", fCheckbox3, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gate2, "gate2", fCheckbox2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gate3, "gate3", fCheckbox1, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gate4, "gate4", fCheckbox0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, index1, "index1", fHslider1, 1.0f, 0.0f, 2e+01f, 1.0f) \
		p(HORIZONTALSLIDER, modfreq1, "modfreq1", fHslider0, 5e+01f, 0.1f, 1e+02f, 0.1f) \
