  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec0[0] = 1;
			iRec0[0] = (iVec0[1] + iRec0[1]) % 32768;
			table[i1] = std::sin(0.0001917476f * float(iRec0[0]));
			iVec0[1] = iVec0[0];
			iRec0[1] = iRec0[0];
		}
	}
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("library_path10", "/libraries/synths.lib");
		m->declare("library_path11", "/libraries/routes.lib");
		m->declare("library_path12", "/libraries/delays.lib");
		...
		m->declare("library_path6", "/libraries/physmodels.lib");
		m->declare("library_path7", "/libraries/signals.lib");
		m->declare("library_path8", "/libraries/noises.lib");
		m->declare("library_path9", "/libraries/filters.lib");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::max<float>(1.0f, 0.005f * fConst0);
		fConst2 = 1.0f / fConst1;
		fConst3 = 1.0f / std::max<float>(1.0f, 0.05f * fConst0);
		fConst4 = 1.0f / std::max<float>(1.0f, 0.1f * fConst0);
		fConst5 = 2e+02f / fConst0;
		float fConst6 = std::tan(1570.7964f / fConst0);
		fConst7 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst6));
		float fConst8 = 1.0f / fConst6;
		fConst9 = (fConst8 + -0.82372326f) / fConst6 + 1.0f;
		fConst10 = 1.0f / ((fConst8 + 0.82372326f) / fConst6 + 1.0f);
		fConst11 = std::max<float>(1.0f, 0.006f * fConst0);
		fConst12 = 1.0f / fConst11;
		fConst13 = 1.0f / std::max<float>(1.0f, 0.022f * fConst0);
		fConst14 = std::max<float>(1.0f, 0.016f * fConst0);
		fConst15 = 1.0f / fConst14;
		fConst16 = 1.0f / std::max<float>(1.0f, 0.042f * fConst0);
		fConst17 = std::max<float>(1.0f, 0.026f * fConst0);
		fConst18 = 1.0f / fConst17;
		fConst19 = 1.0f / std::max<float>(1.0f, 0.052f * fConst0);
		fConst20 = std::max<float>(1.0f, 0.036f * fConst0);
		fConst21 = 1.0f / fConst20;
		fConst22 = 1.0f / std::max<float>(1.0f, 0.062f * fConst0);
		fConst23 = 3e+03f / fConst0;
		float fConst24 = std::tan(56548.668f / fConst0);
		...
		fConst29 = 6.34e+03f / fConst0;
		fConst30 = 3.17e+03f / fConst0;
		fConst31 = 0.00882353f * fConst0;
		fConst32 = 44.1f / fConst0;
		fConst33 = 1.0f - fConst32;
		fConst34 = 0.0014705883f * fConst0;
		fConst35 = 15.707964f / fConst0;
		fConst36 = 0.002f * fConst0;
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider4 = FAUSTFLOAT(0.8f);
		fCheckbox7 = FAUSTFLOAT(0.0f);
		fHslider5 = FAUSTFLOAT(0.5f);
		fHslider6 = FAUSTFLOAT(5e+01f);
		fHslider7 = FAUSTFLOAT(1.0f);
		fHslider8 = FAUSTFLOAT(587.33f);
		fCheckbox8 = FAUSTFLOAT(0.0f);
		fHslider9 = FAUSTFLOAT(587.33f);
		fHslider10 = FAUSTFLOAT(587.33f);
		fHslider11 = FAUSTFLOAT(587.33f);
		fCheckbox9 = FAUSTFLOAT(0.0f);
		fHslider12 = FAUSTFLOAT(349.2f);
		fCheckbox10 = FAUSTFLOAT(0.0f);
		fHslider13 = FAUSTFLOAT(523.25f);
		fCheckbox11 = FAUSTFLOAT(0.0f);
		fHslider14 = FAUSTFLOAT(4.4e+02f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("at", &fHslider17, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("dt", &fHslider18, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("freqSynth1", &fHslider14, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freqSynth2", &fHslider13, FAUSTFLOAT(523.25f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freqSynth3", &fHslider12, FAUSTFLOAT(349.2f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freqSynth4", &fHslider11, FAUSTFLOAT(587.33f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freqSynth5", &fHslider10, FAUSTFLOAT(587.33f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freqSynth6", &fHslider9, FAUSTFLOAT(587.33f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freqSynth7", &fHslider8, FAUSTFLOAT(587.33f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		...
		ui_interface->addCheckButton("gateSynth", &fCheckbox13);
		ui_interface->addCheckButton("gateSynth1", &fCheckbox12);
		ui_interface->addCheckButton("gateSynth2", &fCheckbox11);
		ui_interface->addCheckButton("gateSynth3", &fCheckbox10);
		ui_interface->addCheckButton("gateSynth4", &fCheckbox9);
		ui_interface->addCheckButton("gateSynth5", &fCheckbox8);
		...
		ui_interface->addHorizontalSlider("sustain", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
		ui_interface->declare(&fButton0, "4", "");
		ui_interface->addButton("gate", &fButton0);
		ui_interface->addHorizontalSlider("outGain", &fHslider5, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider3, "midi", "ctrl 1");
		ui_interface->addHorizontalSlider("pluckPosition", &fHslider3, FAUSTFLOAT(0.8f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
		ui_interface->addHorizontalSlider("index1", &fHslider7, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("modfreq1", &fHslider6, FAUSTFLOAT(5e+01f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("pitch", &fHslider15, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.5f), FAUSTFLOAT(1.5f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("rt", &fHslider16, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("sl", &fHslider19, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow6 = float(fCheckbox3);
		int iSlow7 = fSlow6 == 0.0f;
		float fSlow8 = float(fCheckbox4);
		int iSlow9 = fSlow8 == 0.0f;
		float fSlow10 = float(fCheckbox5);
		int iSlow11 = fSlow10 == 0.0f;
		float fSlow12 = float(fCheckbox6);
		float fSlow13 = std::min<float>(1.0f, float(fHslider0) + float(fButton0));
		int iSlow14 = fSlow13 == 0.0f;
		float fSlow15 = std::pow(2.0f, 0.083333336f * float(fHslider1));
		float fSlow16 = float(fHslider2);
		float fSlow17 = 3.4e+02f / fSlow16;
		float fSlow18 = fConst32 * float(fHslider3);
		float fSlow19 = fConst35 * fSlow16;
		float fSlow20 = 0.00033333333f * fSlow16;
		float fSlow21 = float(fHslider4);
		float fSlow22 = 2.0f * float(fHslider5) * float(fCheckbox7);
		float fSlow23 = fConst37 * float(fHslider6);
		float fSlow24 = float(fHslider7);
		float fSlow25 = float(fHslider8);
		float fSlow26 = float(fCheckbox8);
		float fSlow27 = float(fHslider9);
		float fSlow28 = float(fHslider10);
		float fSlow29 = float(fHslider11);
		float fSlow30 = float(fCheckbox9);
		float fSlow31 = float(fHslider12);
		float fSlow32 = float(fCheckbox10);
		float fSlow33 = float(fHslider13);
		float fSlow34 = float(fCheckbox11);
		float fSlow35 = float(fHslider15) * float(fHslider14);
		float fSlow36 = float(fCheckbox12);
		float fSlow37 = float(fCheckbox13);
		int iSlow38 = fSlow37 == 0.0f;
		float fSlow39 = 1.0f / std::max<float>(1.0f, fConst0 * float(fHslider16));
		float fSlow40 = std::max<float>(1.0f, fConst0 * float(fHslider17));
		float fSlow41 = 1.0f / fSlow40;
		float fSlow42 = float(fHslider19);
		float fSlow43 = (1.0f - fSlow42) / std::max<float>(1.0f, fConst0 * float(fHslider18));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fVec1[0] = fSlow0;
			fRec2[0] = fSlow0 + fRec2[1] * float(fVec1[1] >= fSlow0);
			float fTemp0 = fConst2 * fRec2[0];
			iRec3[0] = iSlow1 * (iRec3[1] + 1);
			float fTemp1 = 1.0f - fConst4 * float(iRec3[0]);
			float fTemp2 = fRec1[1] + fConst5 * (4.0f * std::max<float>(0.0f, fTemp1 * std::min<float>(fTemp0, std::max<float>(fConst3 * (fConst1 - fRec2[0]) + 1.0f, 0.0f))) + 1.0f);
			fRec1[0] = fTemp2 - std::floor(fTemp2);
			fVec2[0] = fSlow2;
			fRec5[0] = fSlow2 + fRec5[1] * float(fVec2[1] >= fSlow2);
			float fTemp3 = fConst2 * fRec5[0];
			iRec6[0] = iSlow3 * (iRec6[1] + 1);
			float fTemp4 = 1.0f - fConst4 * float(iRec6[0]);
			float fTemp5 = fRec4[1] + fConst5 * (4.0f * std::max<float>(0.0f, fTemp4 * std::min<float>(fTemp3, std::max<float>(fConst3 * (fConst1 - fRec5[0]) + 1.0f, 0.0f))) + 1.0f);
			fRec4[0] = fTemp5 - std::floor(fTemp5);
			fVec3[0] = fSlow4;
			fRec8[0] = fSlow4 + fRec8[1] * float(fVec3[1] >= fSlow4);
			iRec9[0] = iSlow5 * (iRec9[1] + 1);
			float fTemp6 = 1.0f - fConst4 * float(iRec9[0]);
			iRec10[0] = 1103515245 * iRec10[1] + 12345;
			float fTemp7 = float(iRec10[0]);
			fRec7[0] = 4.656613e-10f * fTemp7 * (std::max<float>(0.0f, std::min<float>(fConst21 * fRec8[0], std::max<float>(fConst22 * (fConst20 - fRec8[0]) + 1.0f, 0.0f)) * fTemp6) + std::max<float>(0.0f, fTemp6 * std::min<float>(fConst18 * fRec8[0], std::max<float>(fConst19 * (fConst17 - fRec8[0]) + 1.0f, 0.0f))) + std::max<float>(0.0f, fTemp6 * std::min<float>(fConst15 * fRec8[0], std::max<float>(fConst16 * (fConst14 - fRec8[0]) + 1.0f, 0.0f))) + std::max<float>(0.0f, fTemp6 * std::min<float>(fConst12 * fRec8[0], std::max<float>(fConst13 * (fConst11 - fRec8[0]) + 1.0f, 0.0f)))) - fConst10 * (fConst9 * fRec7[2] + fConst7 * fRec7[1]);
			fVec4[0] = fSlow6;
			fRec12[0] = fSlow6 + fRec12[1] * float(fVec4[1] >= fSlow6);
			iRec13[0] = iSlow7 * (iRec13[1] + 1);
			float fTemp8 = 1.0f - fConst4 * float(iRec13[0]);
			fRec11[0] = 4.656613e-10f * fTemp7 * (std::max<float>(0.0f, std::min<float>(fConst21 * fRec12[0], std::max<float>(fConst22 * (fConst20 - fRec12[0]) + 1.0f, 0.0f)) * fTemp8) + std::max<float>(0.0f, fTemp8 * std::min<float>(fConst18 * fRec12[0], std::max<float>(fConst19 * (fConst17 - fRec12[0]) + 1.0f, 0.0f))) + std::max<float>(0.0f, fTemp8 * std::min<float>(fConst15 * fRec12[0], std::max<float>(fConst16 * (fConst14 - fRec12[0]) + 1.0f, 0.0f))) + std::max<float>(0.0f, fTemp8 * std::min<float>(fConst12 * fRec12[0], std::max<float>(fConst13 * (fConst11 - fRec12[0]) + 1.0f, 0.0f)))) - fConst10 * (fConst9 * fRec11[2] + fConst7 * fRec11[1]);
			fVec5[0] = fSlow8;
			fRec15[0] = fSlow8 + fRec15[1] * float(fVec5[1] >= fSlow8);
			float fTemp9 = fConst2 * fRec15[0];
			iRec16[0] = iSlow9 * (iRec16[1] + 1);
			float fTemp10 = 1.0f - fConst4 * float(iRec16[0]);
			float fTemp11 = fRec14[1] + fConst23 * (4.0f * std::max<float>(0.0f, fTemp10 * std::min<float>(fTemp9, std::max<float>(fConst3 * (fConst1 - fRec15[0]) + 1.0f, 0.0f))) + 1.0f);
			fRec14[0] = fTemp11 - std::floor(fTemp11);
			fVec6[0] = fSlow10;
			fRec18[0] = fSlow10 + fRec18[1] * float(fVec6[1] >= fSlow10);
			float fTemp12 = fConst2 * fRec18[0];
			iRec19[0] = iSlow11 * (iRec19[1] + 1);
			float fTemp13 = 1.0f - fConst4 * float(iRec19[0]);
			float fTemp14 = fRec17[1] + fConst23 * (4.0f * std::max<float>(0.0f, fTemp13 * std::min<float>(fTemp12, std::max<float>(fConst3 * (fConst1 - fRec18[0]) + 1.0f, 0.0f))) + 1.0f);
			fRec17[0] = fTemp14 - std::floor(fTemp14);
			float fTemp15 = fConst3 * fRec2[0];
			float fTemp16 = fConst3 * fRec5[0];
			fRec21[0] = fConst29 + (fRec21[1] - float(int(fConst29 + fRec21[1])));
			float fTemp17 = fRec21[0] + 9.313226e-10f * fTemp7;
			fRec22[0] = fConst30 + (fRec22[1] - float(int(fConst30 + fRec22[1])));
			float fTemp18 = fRec22[0] + 2.0f * std::sin(6.2831855f * (fTemp17 - std::floor(fTemp17)));
			fRec20[0] = std::sin(6.2831855f * (fTemp18 - std::floor(fTemp18))) - fConst28 * (fConst27 * fRec20[2] + fConst25 * fRec20[1]);
			iRec33[0] = 0;
			int iRec34 = iRec33[1];
			float fRec37 = float(iRec29[1]) - 0.9978437f * (0.7f * fRec38[2] + 0.15f * (fRec38[1] + fRec38[3]));
			fVec7[0] = fSlow13;
			float fTemp19 = float((fSlow13 == fVec7[1]) | iSlow14);
			fRec48[0] = fSlow15 * (1.0f - 0.999f * fTemp19) + 0.999f * fTemp19 * fRec48[1];
			float fTemp20 = fSlow17 / fRec48[0] + -0.1f;
			fRec49[0] = fSlow18 + fConst33 * fRec49[1];
			float fTemp21 = fConst34 * (1.0f - fRec49[0]) * fTemp20;
			float fTemp22 = fTemp21 + -1.499995f;
			int iTemp23 = int(fTemp22);
			int iTemp24 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp23 + 4))));
			...
			int iTemp33 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp23 + 3))));
			float fTemp34 = 0.0f - 0.5f * fTemp31;
			float fTemp35 = 0.0f - fTemp26;
			int iTemp36 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp23 + 2))));
			float fTemp37 = 0.0f - 0.33333334f * fTemp31;
			float fTemp38 = 0.0f - 0.5f * fTemp26;
			float fTemp39 = 0.0f - fTemp27;
			int iTemp40 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp23 + 1))));
			...
			int iTemp46 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp23))));
			fRec45[0] = fRec25[(IOTA0 - (iTemp46 + 1)) & 2047] * fTemp45 * fTemp44 * fTemp43 * fTemp42 + fTemp41 * (fRec25[(IOTA0 - (iTemp40 + 1)) & 2047] * fTemp39 * fTemp38 * fTemp37 + 0.5f * fTemp28 * fRec25[(IOTA0 - (iTemp36 + 1)) & 2047] * fTemp35 * fTemp34 + 0.16666667f * fTemp29 * fRec25[(IOTA0 - (iTemp33 + 1)) & 2047] * fTemp32 + 0.041666668f * fTemp30 * fRec25[(IOTA0 - (iTemp24 + 1)) & 2047]);
			fRec50[0] = 0.95f * fRec45[1] + 0.05f * fRec50[1];
			float fRec46 = fRec50[0];
			float fTemp47 = std::tan(fSlow19 * fRec48[0]);
			float fTemp48 = 1.0f / fTemp47;
			float fTemp49 = (fTemp48 + 1.4142135f) / fTemp47 + 1.0f;
			iRec52[0] = (iRec52[1] + (iRec52[1] > 0)) * (fSlow13 <= fVec7[1]) + (fSlow13 > fVec7[1]);
			float fTemp50 = float(iRec52[0]) / std::max<float>(1.0f, fConst36 * mydsp_faustpower2_f(1.0f - fSlow20 * fRec48[0]));
			fRec53[0] = 4.656613e-10f * fTemp7 - (fRec53[2] * ((fTemp48 + -1.4142135f) / fTemp47 + 1.0f) + 2.0f * fRec53[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp47))) / fTemp49;
			float fTemp51 = fSlow21 * ((fRec53[2] + fRec53[0] + 2.0f * fRec53[1]) * std::max<float>(0.0f, std::min<float>(fTemp50, 2.0f - fTemp50)) / fTemp49);
			fRec54[0] = fRec23[1];
			fRec55[IOTA0 & 2047] = -1.0f * 0.9978437f * (0.7f * fRec54[2] + 0.15f * (fRec54[1] + fRec54[3]));
			float fTemp52 = fConst34 * fRec49[0] * fTemp20;
			float fTemp53 = fTemp52 + -1.499995f;
			int iTemp54 = int(fTemp53);
			int iTemp55 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp54 + 4))));
			float fTemp56 = std::floor(fTemp53);
			float fTemp57 = fTemp52 + (-3.0f - fTemp56);
			float fTemp58 = fTemp52 + (-2.0f - fTemp56);
			float fTemp59 = fTemp52 + (-1.0f - fTemp56);
			float fTemp60 = fTemp59 * fTemp58;
			float fTemp61 = fTemp60 * fTemp57;
			float fTemp62 = fTemp52 + (-4.0f - fTemp56);
			float fTemp63 = 0.0f - fTemp62;
			int iTemp64 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp54 + 3))));
			float fTemp65 = 0.0f - 0.5f * fTemp62;
			float fTemp66 = 0.0f - fTemp57;
			int iTemp67 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp54 + 2))));
			float fTemp68 = 0.0f - 0.33333334f * fTemp62;
			float fTemp69 = 0.0f - 0.5f * fTemp57;
			float fTemp70 = 0.0f - fTemp58;
			int iTemp71 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp54 + 1))));
			float fTemp72 = fTemp52 - fTemp56;
			float fTemp73 = 0.0f - 0.25f * fTemp62;
			float fTemp74 = 0.0f - 0.33333334f * fTemp57;
			float fTemp75 = 0.0f - 0.5f * fTemp58;
			float fTemp76 = 0.0f - fTemp59;
			int iTemp77 = int(std::min<float>(fConst31, float(std::max<int>(0, iTemp54))));
			fVec8[0] = fRec55[(IOTA0 - (iTemp77 + 2)) & 2047] * fTemp76 * fTemp75 * fTemp74 * fTemp73 + fTemp72 * (fRec55[(IOTA0 - (iTemp71 + 2)) & 2047] * fTemp70 * fTemp69 * fTemp68 + 0.5f * fTemp59 * fRec55[(IOTA0 - (iTemp67 + 2)) & 2047] * fTemp66 * fTemp65 + 0.16666667f * fTemp60 * fRec55[(IOTA0 - (iTemp64 + 2)) & 2047] * fTemp63 + 0.041666668f * fTemp61 * fRec55[(IOTA0 - (iTemp55 + 2)) & 2047]);
			fVec9[0] = fVec8[1] + fTemp51;
			fRec51[IOTA0 & 2047] = 0.95f * fVec9[1] + 0.05f * fRec51[(IOTA0 - 1) & 2047];
			float fRec47 = fTemp45 * fTemp44 * fTemp43 * fTemp42 * fRec51[(IOTA0 - iTemp46) & 2047] + fTemp41 * (fTemp39 * fTemp38 * fTemp37 * fRec51[(IOTA0 - iTemp40) & 2047] + 0.5f * fTemp28 * fTemp35 * fTemp34 * fRec51[(IOTA0 - iTemp36) & 2047] + 0.16666667f * fTemp29 * fTemp32 * fRec51[(IOTA0 - iTemp33) & 2047] + 0.041666668f * fTemp30 * fRec51[(IOTA0 - iTemp24) & 2047]);
			fRec42[0] = fRec46;
			float fRec43 = fTemp51 + fRec42[1];
			float fRec44 = fRec47;
			fRec39[IOTA0 & 2047] = fRec43;
			float fRec40 = fTemp76 * fTemp75 * fTemp74 * fTemp73 * fRec39[(IOTA0 - (iTemp77 + 1)) & 2047] + fTemp72 * (fTemp70 * fTemp69 * fTemp68 * fRec39[(IOTA0 - (iTemp71 + 1)) & 2047] + 0.5f * fTemp59 * fTemp66 * fTemp65 * fRec39[(IOTA0 - (iTemp67 + 1)) & 2047] + 0.16666667f * fTemp60 * fTemp63 * fRec39[(IOTA0 - (iTemp64 + 1)) & 2047] + 0.041666668f * fTemp61 * fRec39[(IOTA0 - (iTemp55 + 1)) & 2047]);
			fRec41[0] = fRec44;
			fRec38[0] = fRec41[1];
			float fRec35 = fRec38[1];
			float fRec36 = fRec38[1];
			iRec29[0] = iRec34;
			float fRec30 = fRec37;
			float fRec31 = fRec35;
			float fRec32 = fRec36;
			fRec25[IOTA0 & 2047] = fRec30;
			float fRec26 = fRec40;
			float fRec27 = fRec31;
			float fRec28 = fRec32;
			fRec23[0] = fRec26;
			float fRec24 = fRec28;
			fRec57[0] = fSlow23 + (fRec57[1] - std::floor(fSlow23 + fRec57[1]));
			float fTemp78 = fSlow24 * ftbl0mydspSIG0[int(32768.0f * fRec57[0])];
			float fTemp79 = fRec56[1] + fConst37 * (fSlow25 + fTemp78);
			fRec56[0] = fTemp79 - std::floor(fTemp79);
			float fTemp80 = fRec58[1] + fConst37 * (fSlow27 + fTemp78);
			fRec58[0] = fTemp80 - std::floor(fTemp80);
			float fTemp81 = fRec59[1] + fConst37 * (fSlow28 + fTemp78);
			fRec59[0] = fTemp81 - std::floor(fTemp81);
			float fTemp82 = fRec60[1] + fConst37 * (fSlow29 + fTemp78);
			fRec60[0] = fTemp82 - std::floor(fTemp82);
			float fTemp83 = fRec61[1] + fConst37 * (fSlow31 + fTemp78);
			fRec61[0] = fTemp83 - std::floor(fTemp83);
			float fTemp84 = fRec62[1] + fConst37 * (fSlow33 + fTemp78);
			fRec62[0] = fTemp84 - std::floor(fTemp84);
			float fTemp85 = fRec63[1] + fConst37 * (fSlow35 + fTemp78);
			fRec63[0] = fTemp85 - std::floor(fTemp85);
			fVec10[0] = fSlow37;
			iRec64[0] = iSlow38 * (iRec64[1] + 1);
			fRec65[0] = fSlow37 + fRec65[1] * float(fVec10[1] >= fSlow37);
			output0[i0] = FAUSTFLOAT(fSlow37 * std::max<float>(0.0f, std::min<float>(fSlow41 * fRec65[0], std::max<float>(fSlow43 * (fSlow40 - fRec65[0]) + 1.0f, fSlow42)) * (1.0f - fSlow39 * float(iRec64[0]))) * (fSlow36 * ftbl0mydspSIG0[int(32768.0f * fRec63[0])] + fSlow34 * ftbl0mydspSIG0[int(32768.0f * fRec62[0])] + fSlow32 * ftbl0mydspSIG0[int(32768.0f * fRec61[0])] + fSlow30 * ftbl0mydspSIG0[int(32768.0f * fRec60[0])] + fSlow26 * ftbl0mydspSIG0[int(32768.0f * fRec59[0])] + fSlow26 * ftbl0mydspSIG0[int(32768.0f * fRec58[0])] + fSlow26 * ftbl0mydspSIG0[int(32768.0f * fRec56[0])]) + fSlow22 * fRec24 + fSlow12 * (fConst28 * (fRec20[2] + fRec20[0] + 2.0f * fRec20[1]) * (std::max<float>(0.0f, fTemp4 * std::min<float>(fTemp16, std::max<float>(2.0f - fTemp16, 0.0f))) + std::max<float>(0.0f, fTemp1 * std::min<float>(fTemp15, std::max<float>(2.0f - fTemp15, 0.0f)))) + tanhf(5.0f * std::max<float>(0.0f, std::min<float>(fTemp12, std::max<float>(2.0f - fTemp12, 0.0f)) * fTemp13) * ftbl0mydspSIG0[int(32768.0f * fRec17[0])]) + tanhf(5.0f * std::max<float>(0.0f, std::min<float>(fTemp9, std::max<float>(2.0f - fTemp9, 0.0f)) * fTemp10) * ftbl0mydspSIG0[int(32768.0f * fRec14[0])]) + tanhf(fConst10 * (fRec11[2] + fRec11[0] + 2.0f * fRec11[1])) + tanhf(fConst10 * (fRec7[2] + fRec7[0] + 2.0f * fRec7[1])) + tanhf(5.0f * std::max<float>(0.0f, std::min<float>(fTemp3, std::max<float>(2.0f - fTemp3, 0.0f)) * fTemp4) * ftbl0mydspSIG0[int(32768.0f * fRec4[0])]) + tanhf(5.0f * std::max<float>(0.0f, std::min<float>(fTemp0, std::max<float>(2.0f - fTemp0, 0.0f)) * fTemp1) * ftbl0mydspSIG0[int(32768.0f * fRec1[0])])));
			fVec1[1] = fVec1[0];
			fRec2[1] = fRec2[0];
			iRec3[1] = iRec3[0];
			fRec1[1] = fRec1[0];
	...
	FAUST_ADDHORIZONTALSLIDER("at", fHslider17, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("dt", fHslider18, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("freqSynth1", fHslider14, 4.4e+02f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freqSynth2", fHslider13, 523.25f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freqSynth3", fHslider12, 349.2f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freqSynth4", fHslider11, 587.33f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freqSynth5", fHslider10, 587.33f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freqSynth6", fHslider9, 587.33f, 2e+01f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("freqSynth7", fHslider8, 587.33f, 2e+01f, 5e+03f, 0.1f);
	...
	FAUST_ADDCHECKBOX("gateSynth", fCheckbox13);
	FAUST_ADDCHECKBOX("gateSynth1", fCheckbox12);
	FAUST_ADDCHECKBOX("gateSynth2", fCheckbox11);
	FAUST_ADDCHECKBOX("gateSynth3", fCheckbox10);
	FAUST_ADDCHECKBOX("gateSynth4", fCheckbox9);
	FAUST_ADDCHECKBOX("gateSynth5", fCheckbox8);
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/freq", fHslider2, 4.4e+02f, 5e+01f, 1e+03f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/bend", fHslider1, 0.0f, -2.0f, 2.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/gain", fHslider4, 0.8f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/sustain", fHslider0, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDBUTTON("guitar/gate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("guitar/outGain", fHslider5, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/pluckPosition", fHslider3, 0.8f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("index1", fHslider7, 1.0f, 0.0f, 2e+01f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("modfreq1", fHslider6, 5e+01f, 0.1f, 1e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("pitch", fHslider15, 1.0f, 0.5f, 1.5f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("rt", fHslider16, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("sl", fHslider19, 0.5f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, at, "at", fHslider17, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, dt, "dt", fHslider18, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, freqSynth1, "freqSynth1", fHslider14, 4.4e+02f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freqSynth2, "freqSynth2", fHslider13, 523.25f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freqSynth3, "freqSynth3", fHslider12, 349.2f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freqSynth4, "freqSynth4", fHslider11, 587.33f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freqSynth5, "freqSynth5", fHslider10, 587.33f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freqSynth6, "freqSynth6", fHslider9, 587.33f, 2e+01f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, freqSynth7, "freqSynth7", fHslider8, 587.33f, 2e+01f, 5e+03f, 0.1f) \
		...
		p(CHECKBOX, gateSynth, "gateSynth", fCheckbox13, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gateSynth1, "gateSynth1", fCheckbox12, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gateSynth2, "gateSynth2", fCheckbox11, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gateSynth3, "gateSynth3", fCheckbox10, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gateSynth4, "gateSynth4", fCheckbox9, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, gateSynth5, "gateSynth5", fCheckbox8, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, freq, "guitar/[0]midi/freq", fHslider2, 4.4e+02f, 5e+01f, 1e+03f, 0.01f) \
		p(HORIZONTALSLIDER, bend, "guitar/[0]midi/bend", fHslider1, 0.0f, -2.0f, 2.0f, 0.01f) \
		p(HORIZONTALSLIDER, gain, "guitar/[0]midi/gain", fHslider4, 0.8f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, sustain, "guitar/[0]midi/sustain", fHslider0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, gate, "guitar/gate", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, outGain, "guitar/outGain", fHslider5, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, pluckPosition, "guitar/pluckPosition", fHslider3, 0.8f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, index1, "index1", fHslider7, 1.0f, 0.0f, 2e+01f, 1.0f) \
		p(HORIZONTALSLIDER, modfreq1, "modfreq1", fHslider6, 5e+01f, 0.1f, 1e+02f, 0.1f) \
		p(HORIZONTALSLIDER, pitch, "pitch", fHslider15, 1.0f, 0.5f, 1.5f, 0.1f) \
		p(HORIZONTALSLIDER, rt, "rt", fHslider16, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, sl, "sl", fHslider19, 0.5f, 0.0f, 1.0f, 0.01f) \
