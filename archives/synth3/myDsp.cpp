...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("filterFreq", &fHslider6, FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4e+02f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = 0.0f - 2.0f * std::cos(fConst1 * float(fHslider0));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = fTemp0 - (fSlow0 * fRec2[1] + fRec2[2]);
			float fTemp1 = fSlow1 * fRec2[0];
			fRec1[0] = fTemp0 - (fRec1[1] * (0.0f - 2.0f * std::cos(fConst1 * (fSlow2 + fTemp1))) + fRec1[2]);
			fRec3[0] = fTemp0 - (fRec3[1] * (0.0f - 2.0f * std::cos(fConst1 * (fSlow4 + fTemp1))) + fRec3[2]);
			fRec4[0] = fTemp0 - (fRec4[1] * (0.0f - 2.0f * std::cos(fConst1 * (fSlow6 + fTemp1))) + fRec4[2]);
			fRec5[0] = fTemp0 - (fRec5[1] * (0.0f - 2.0f * std::cos(fConst1 * (fSlow8 + fTemp1))) + fRec5[2]);
			float fTemp2 = fSlow10 * (fSlow9 * fRec5[0] + fSlow7 * fRec4[0] + fSlow5 * fRec3[0] + fSlow3 * fRec1[0]);
			fVec1[0] = fTemp2;
			fRec0[0] = 0.0f - fSlow13 * (fSlow12 * fRec0[1] - (fTemp2 + fVec1[1]));
	...
	FAUST_ADDHORIZONTALSLIDER("filterFreq", fHslider6, 1e+01f, 0.0f, 4e+02f, 0.1f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, filterFreq, "filterFreq", fHslider6, 1e+01f, 0.0f, 4e+02f, 0.1f) \
