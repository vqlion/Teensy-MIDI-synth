...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("library_path4", "/libraries/filters.lib");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("ctfreq", &fHslider0, FAUSTFLOAT(1e+03f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider1, "midi", "ctrl 73");
		ui_interface->addHorizontalSlider("freq", &fHslider1, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("gain", &fHslider2, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addButton("gate", &fButton0);
		ui_interface->addHorizontalSlider("third", &fHslider3, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = std::max<float>(1.1920929e-07f, std::fabs(1.5f * fSlow1));
		float fSlow3 = fConst4 * fSlow2;
		float fSlow4 = 1.0f - fConst0 / fSlow2;
		float fSlow5 = float(fButton0) * float(fHslider2);
		float fSlow6 = std::max<float>(1.1920929e-07f, std::fabs(fSlow1 * (float(fHslider3) + 1.2f)));
		float fSlow7 = fConst4 * fSlow6;
		float fSlow8 = 1.0f - fConst0 / fSlow6;
		float fSlow9 = std::max<float>(1.1920929e-07f, std::fabs(fSlow1));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = (fTemp1 + 0.2f) / fTemp0 + 1.0f;
			float fTemp3 = 1.0f - 1.0f / mydsp_faustpower2_f(fTemp0);
			float fTemp4 = (fTemp1 + -0.2f) / fTemp0 + 1.0f;
			float fTemp5 = fSlow3 + fRec2[1] + -1.0f;
			int iTemp6 = fTemp5 < 0.0f;
			float fTemp7 = fSlow3 + fRec2[1];
			fRec2[0] = ((iTemp6) ? fTemp7 : fTemp5);
			float fThen1 = fSlow3 + fRec2[1] + fSlow4 * fTemp5;
			float fRec3 = ((iTemp6) ? fTemp7 : fThen1);
			fRec1[0] = fSlow5 * (2.0f * fRec3 + -1.0f) - (fTemp4 * fRec1[2] + 2.0f * fTemp3 * fRec1[1]) / fTemp2;
			float fTemp8 = fSlow7 + fRec5[1] + -1.0f;
			int iTemp9 = fTemp8 < 0.0f;
			float fTemp10 = fSlow7 + fRec5[1];
			fRec5[0] = ((iTemp9) ? fTemp10 : fTemp8);
			float fThen3 = fSlow7 + fRec5[1] + fSlow8 * fTemp8;
			float fRec6 = ((iTemp9) ? fTemp10 : fThen3);
			fRec4[0] = fSlow5 * (2.0f * fRec6 + -1.0f) - (fTemp4 * fRec4[2] + 2.0f * fTemp3 * fRec4[1]) / fTemp2;
			float fTemp11 = fSlow10 + fRec8[1] + -1.0f;
			int iTemp12 = fTemp11 < 0.0f;
			float fTemp13 = fSlow10 + fRec8[1];
			fRec8[0] = ((iTemp12) ? fTemp13 : fTemp11);
			float fThen5 = fSlow10 + fRec8[1] + fSlow11 * fTemp11;
			float fRec9 = ((iTemp12) ? fTemp13 : fThen5);
			fRec7[0] = fSlow5 * (2.0f * fRec9 + -1.0f) - (fRec7[2] * fTemp4 + 2.0f * fRec7[1] * fTemp3) / fTemp2;
			float fTemp14 = 0.3f * ((fRec7[2] + fRec7[0] + 2.0f * fRec7[1] + fRec4[2] + fRec4[0] + 2.0f * fRec4[1] + fRec1[2] + fRec1[0] + 2.0f * fRec1[1]) / fTemp2);
	...
	FAUST_ADDHORIZONTALSLIDER("ctfreq", fHslider0, 1e+03f, 5e+01f, 5e+03f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("freq", fHslider1, 4.4e+02f, 5e+01f, 2e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("gain", fHslider2, 1.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDBUTTON("gate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("third", fHslider3, 1.0f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, ctfreq, "ctfreq", fHslider0, 1e+03f, 5e+01f, 5e+03f, 0.01f) \
		p(HORIZONTALSLIDER, freq, "freq", fHslider1, 4.4e+02f, 5e+01f, 2e+03f, 1.0f) \
		p(HORIZONTALSLIDER, gain, "gain", fHslider2, 1.0f, 0.0f, 1.0f, 0.01f) \
		p(BUTTON, gate, "gate", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, third, "third", fHslider3, 1.0f, 0.0f, 1.0f, 0.01f) \
